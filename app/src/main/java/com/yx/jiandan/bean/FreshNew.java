...
//    private Tags tags;
    ...
    public static ArrayList<FreshNew> parse(JSONArray postsArray) {

        ArrayList<FreshNew> freshNewses = new ArrayList<>();

        for (int i = 0; i < postsArray.length(); i++) {

            FreshNew freshNews = new FreshNew();
...
//            freshNews.setTags(Tags.parse(jsonObject.optJSONArray("tags")));
    ...
    public static ArrayList<FreshNew> parseCache(JSONArray postsArray) {
