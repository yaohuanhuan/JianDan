package com.yx.jiandan.ui.imageload;
...
import com.yx.jiandan.BuildConfig;
...
public class ImageLoadProxy {
    ...
    public static DisplayImageOptions getOptions4Header() {
        return new DisplayImageOptions.Builder()
                ...
                .cacheOnDisk(true)
                .bitmapConfig(Bitmap.Config.RGB_565)
                .showImageForEmptyUri(R.mipmap.ic_loading_small)
                .showImageOnFail(R.mipmap.ic_loading_small)
                .showImageOnLoading(R.mipmap.ic_loading_small)
                .build();
    }
